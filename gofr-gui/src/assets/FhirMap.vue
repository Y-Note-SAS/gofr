            ...
            <v-tab-item key="Search" value="tab-search">
              <v-form @submit.prevent="onSearch">
                ...
                <v-text-field
                  ...
                  id="system"
                  v-model="form.system"
                  :placeholder="$t(`App.hardcoded-texts.system`)"
                  :label="$t(`App.hardcoded-texts.system`)"
                ></v-text-field>
                ...
                <v-text-field
                  ...
                  :placeholder="$t(`App.hardcoded-texts.name`)"
                ></v-text-field>
                <v-select
                  filled
                  outlined
                ...
                <v-text-field
                  ...
                  outlined
                  color="#2d7a5e"
                  :label="$t(`App.hardcoded-texts.limit`)"
                  type="number"
                  id="count"
                  v-model="form.count"
                ></v-text-field>
      ...
      searchTypes: [
        {
          key: "identifier",
          system: true,
          label: "$t(`App.hardcoded-texts.identifier`)",
          placeholder: "$t(`App.hardcoded-texts.identifier`)..",
          options: ["=", ":$t(`App.hardcoded-texts.text`)", ":$t(`App.hardcoded-texts.not`)", ":$t(`App.hardcoded-texts.not-in`)", ":$t(`App.hardcoded-texts.above`)", ":$t(`App.hardcoded-texts.bellow`)", ":$t(`App.hardcoded-texts.in`)"],
        },
        {
          key: "type",
          system: true,
...
'$i18n.locale': {
      handler() {
        // Update all searchTypes translations
        this.searchTypes = [
          {
            key: "identifier",
            system: true,
            label: this.$t("App.hardcoded-texts.identifier"),
            placeholder: this.$t("App.hardcoded-texts.identifier") + "..",
            options: [
              "=",
              ":" + this.$t("App.hardcoded-texts.text"),
              ":" + this.$t("App.hardcoded-texts.not"),
              ":" + this.$t("App.hardcoded-texts.not-in"),
              ":" + this.$t("App.hardcoded-texts.above"),
              ":" + this.$t("App.hardcoded-texts.below"),
              ":" + this.$t("App.hardcoded-texts.in")
            ]
          },
          {
            key: "type",
            system: true,
            label: this.$t("App.hardcoded-texts.type"),
            placeholder: this.$t("App.hardcoded-texts.type") + "..",
            options: [
              "=",
              ":" + this.$t("App.hardcoded-texts.text"),
              ":" + this.$t("App.hardcoded-texts.not"),
          ...
          },
          {
            key: "status",
            system: false,
            label: this.$t("App.hardcoded-texts.status"),
            select: [
              this.$t("App.hardcoded-texts.active"),
              this.$t("App.hardcoded-texts.suspended"),
              this.$t("App.hardcoded-texts.inactive")
            ],
            options: []
          },
          {
            key: "name",
            system: false,
            label: this.$t("App.hardcoded-texts.name"),
            placeholder: this.$t("App.hardcoded-texts.name") + "..",
            options: []
          }
        ];
      },
